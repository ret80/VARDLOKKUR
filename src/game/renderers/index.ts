/* renderers/index.ts – Рендереры сущностей (чистая отрисовка, без состояния) */
...
export function renderEnemy(g: Graphics, data: IEnemyData, time: number) {
  ...
  break;
    ...
    case "ghost": {
      ...
      if (aggr) P(g, -1, -7 + float, 2, 1, 0x0d1a24, a);
...
// ============================================================
// Классы-рендереры (обёртки для вызова функций)
// ============================================================
