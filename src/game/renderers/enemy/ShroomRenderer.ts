...
export class ShroomRenderer extends BaseEnemyRenderer {
  protected drawBody(g: GraphicsHandle, data: IEnemyData, ctx: RenderContext): void {
    ...
    drawEllipse(r, g, 0, 4, 5, 2, { r: 0x05 / 255, g: 0x08 / 255, b: 0x0d / 255, a: 0.5 * a });
    px(r, g, -2, -2 + bob, 5, 6, 0xb9b0a0, a);
    ...
    drawEllipse(r, g, 0, -4 + bob, 7 * charge, 5 * charge, capC);
    ...
    drawEllipse(r, g, 0, -6 + bob, 5 * charge, 2.5 * charge, dc);
    px(r, g, -3, -5 + bob, 1, 1, 0xe8dcc0, a);
    px(r, g, 2, -4 + bob, 1, 1, 0xe8dcc0, a);
    px(r, g, -1, -2 + bob, 1, 1, 0x2a2228, a);
    px(r, g, 2, -2 + bob, 1, 1, 0x2a2228, a);
  }
}
