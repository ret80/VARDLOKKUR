...
export class Engine {
  ...
  private paintWall(ctx: CanvasRenderingContext2D, t: number, v: number, dungeonId: number) {
    ...
    switch (t) {
      case Tl.TREE:
        P(7, 6, 3, 10, 0x241d14); P(7, 6, 1, 10, 0x33291c);
        P(-3, -14, 22, 14, v & 1 ? 0x1d2b22 : 0x17241c);
        P(-1, -16, 18, 6, 0x24352a);
        P(-3, -3, 22, 3, 0x0f1a14);
        if (v & 2) P(3, -13, 4, 2, 0x2e4234);
        break;
      case Tl.ROCK:
      ...
      case Tl.PALISADE:
        for (let i = 0; i < 4; i++) {
          const px = 1 + i * 4;
          P(px, -6, 3, 20, 0x5a4632);
          P(px, -6, 1, 20, 0x6e5840);
          P(px, -8, 3, 2, 0x463626);
        }
        break;
      case Tl.HOUSE:
        P(0, -10, 16, 22, 0x241d14);
        P(1, -8, 14, 4, 0x33291c);
        P(0, -10, 16, 2, 0xc8d3dc);
        P(6, -3, 4, 5, 0x12181f);
        P(1, 4, 3, 3, v & 1 ? 0xe8c979 : 0x8fd8e8);
        P(12, 4, 3, 3, 0x8fd8e8);
        break;
      case Tl.COLUMN:
        P(5, -8, 6, 22, 0x5a6570);
